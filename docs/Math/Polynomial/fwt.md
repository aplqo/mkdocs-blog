...
inline void reverseCopy(unsigned long long dest[], const unsigned long long src[], const unsigned int sz) // same as fft
template <class Func>
void fwt(const unsigned long long src[], unsigned long long dest[], const unsigned int n, Func pred)
{
...
void fwt(const unsigned int n, const unsigned long long a[], const unsigned long long b[], unsigned long long res[], Func pred, iFunc ipred)
{
