...
unsigned long long bsgs(unsigned long long b, const unsigned long long n) // a^x = n ( mod mod )
{
...
inline unsigned long long inverse(long long y, long long p); // y modular inverse p
unsigned long long quickPow(unsigned long long a, unsigned long long e) ;
unsigned long long bsgs(unsigned long long y, unsigned long long z, const unsigned long long r)
{
